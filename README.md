...
Healthcare professional currently training in Computer Science and Artificial Intelligence (3rd year). Background in Clinical Informatics and Data Science.

Focused on digital transformation in healthcare systems, applying machine learning, automation, and data analysis to improve clinical workflows and healthcare processes.

Interested in digital health, computational and digital pathology, medical image analysis, precision medicine, and natural language processing for clinical data.
...
**Machine Learning:** Python · scikit-learn · pandas · NumPy · matplotlib · seaborn · lifelines · OpenCV
